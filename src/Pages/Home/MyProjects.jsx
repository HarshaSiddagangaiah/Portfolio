      ...
      <div className="portfolio--container-box">
        ...
        <div>
          <button
            ...
            onClick={() =>
              window.open(
                "https://github.com/HarshaSiddagangaiah",
                "_blank",
                "noopener,noreferrer"
              )
            }
      ...
      <div class="experience-details-container">
        <div class="about-containers">
          <div class="details-container color-container">
            ...
            <h3 class="experience-sub-title project-title">
              Django application to Support Self Directed Learning
            </h3>
            <div class="btn-container">
              <button
                ...
                onClick={() =>
                  window.open(
                    "https://github.com/HarshaSiddagangaiah/Django-Full-stack-application-for-Student-Portal.git",
                    "_blank",
                    "noopener,noreferrer"
                  )
                }
          ...
          <div class="details-container color-container">
            ...
            <h3 class="experience-sub-title project-title">
              Android App for Corporate Food Management
            </h3>
            <div class="btn-container">
              <button
                ...
                onClick={() =>
                  window.open(
                    "https://github.com/HarshaSiddagangaiah/Android-App-for-Mess-Management.git",
                    "_blank",
                    "noopener,noreferrer"
                  )
                }
          ...
          <div class="details-container color-container">
            ...
            <h3 class="experience-sub-title project-title">
              Parallel Computing the Game of Life in 3D
            </h3>
            <div class="btn-container">
              <button
                class="btn btn-color-2 project-btn"
                onClick={() =>
                  window.open(
                    "https://github.com/HarshaSiddagangaiah/GameOfLife3D.git",
                    "_blank",
                    "noopener,noreferrer"
                  )
                }
